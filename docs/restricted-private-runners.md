...
actions use exact `@v3.3.0` refs, third-party Actions use full commit SHAs
...
jobs:
  ci:
    uses: xoxd-ai/ci-templates/.github/workflows/spoke-ci-restricted.yml@v3.3.0
    with:
...
jobs:
  lane-env:
    uses: xoxd-ai/ci-templates/.github/workflows/spoke-lane-env-restricted.yml@v3.3.0
    with:
      runner_group: tinyland-infra
      nix_runner_label: tinyland-nix
